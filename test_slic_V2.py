...
def main():
    ...
    eval_metrics = validate(model, loader_eval, validate_loss_fn, args, amp_autocast=amp_autocast, is_slic=args.is_slic)
    print("final metric:")
    print(eval_metrics)
    return
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix='', is_slic=True):
